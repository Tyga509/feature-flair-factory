    ...
    <div className="px-4 py-16">
      <div className="mx-auto max-w-5xl">
        <header className="mb-10 animate-fade-in">
          <p className="text-accent font-medium tracking-[0.3em] text-xs uppercase">Votre panier</p>
          <h1 className="font-display text-5xl md:text-6xl mt-2 text-primary">Mon Panier</h1>
        </header>
        ...
        {items.length === 0 ? (
          <div className="bg-card border border-border rounded-3xl p-12 text-center shadow-soft">
            ...
            <h2 className="font-display text-2xl mt-4 text-foreground">Votre panier est vide</h2>
            <p className="text-muted-foreground mt-2">Découvrez nos bouquets et ajoutez vos préférés.</p>
          ...
          <div className="grid gap-8 lg:grid-cols-3">
            ...
            <aside className="bg-gradient-romantic border border-accent/30 rounded-3xl p-6 h-fit shadow-elegant sticky top-28">
              ...
              <dl className="mt-5 space-y-2 text-sm">
                <div className="flex justify-between"><dt className="text-muted-foreground">Articles</dt><dd>{totalItems}</dd></div>
                <div className="flex justify-between"><dt className="text-muted-foreground">Sous-total</dt><dd>{formatPrice(totalPrice)}</dd></div>
                <div className="flex justify-between"><dt className="text-muted-foreground">Livraison</dt><dd className="text-accent font-medium">À convenir</dd></div>
              </dl>
